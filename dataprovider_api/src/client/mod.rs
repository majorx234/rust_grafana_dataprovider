    ...
    C: Has<XSpanIdString>  + Clone + Send + Sync + 'static,
{
        ...
        context: &C) -> Result<ApiPeriodEndpointsPeriodTagKeysResponse, ApiError>
    {
        ...
        match response.status().as_u16() {
            200 => {
                ...
                let body = serde_json::from_str::<Vec<models::ApiEndpointsTagKeys200ResponseInner>>(body).map_err(|e| {
                    ApiError(format!("Response body did not match the schema: {}", e))
                })?;
                Ok(ApiPeriodEndpointsPeriodTagKeysResponse::ListOfAdHocFilterKeys
                    (body)
                )
            }
            code => {
    ...
    async fn api_period_endpoints_period_tag_values(
        &self,
        param_api_endpoints_tag_values_request: models::ApiEndpointsTagValuesRequest,
        context: &C) -> Result<ApiPeriodEndpointsPeriodTagValuesResponse, ApiError>
    {
        ...
        let body = serde_json::to_string(&param_api_endpoints_tag_values_request).expect("impossible to fail to serialize");
    ...
    async fn api_period_endpoints_period_variable(
        &self,
        param_api_endpoints_variable_request: models::ApiEndpointsVariableRequest,
        context: &C) -> Result<ApiPeriodEndpointsPeriodVariableResponse, ApiError>
    {
        ...
        // Body parameter
        let body = serde_json::to_string(&param_api_endpoints_variable_request).expect("impossible to fail to serialize");
        ...
        match response.status().as_u16() {
            200 => {
                ...
                let body = str::from_utf8(&body)
                    .map_err(|e| ApiError(format!("Response was not valid UTF8: {}", e)))?;
                let body = serde_json::from_str::<models::ApiEndpointsVariable200Response>(body).map_err(|e| {
                    ApiError(format!("Response body did not match the schema: {}", e))
                })?;
                Ok(ApiPeriodEndpointsPeriodVariableResponse::VariableItems
                    (body)
                )
            }
            code => {
    ...
    async fn api_period_endpoints_period_list_metric_payload_options(
        &self,
        param_api_endpoints_list_metric_payload_options_request: Option<models::ApiEndpointsListMetricPayloadOptionsRequest>,
        context: &C) -> Result<ApiPeriodEndpointsPeriodListMetricPayloadOptionsResponse, ApiError>
    {
        ...
        // Body parameter
        let body = param_api_endpoints_list_metric_payload_options_request.map(|ref body| {
        ...
        match response.status().as_u16() {
            200 => {
                ...
                let body = str::from_utf8(&body)
                    .map_err(|e| ApiError(format!("Response was not valid UTF8: {}", e)))?;
                let body = serde_json::from_str::<Vec<models::ApiEndpointsListMetricPayloadOptions200ResponseInner>>(body).map_err(|e| {
                    ApiError(format!("Response body did not match the schema: {}", e))
                })?;
                Ok(ApiPeriodEndpointsPeriodListMetricPayloadOptionsResponse::Success
                    (body)
                )
            }
            code => {
    ...
    async fn api_period_endpoints_period_list_metrics(
        &self,
        param_metric_obj: Option<models::MetricObj>,
        context: &C) -> Result<ApiPeriodEndpointsPeriodListMetricsResponse, ApiError>
    {
        ...
        let body = param_metric_obj.map(|ref body| {
            serde_json::to_string(body).expect("impossible to fail to serialize")
        });
        if let Some(body) = body {
                *request.body_mut() = Body::from(body);
        ...
        match response.status().as_u16() {
            200 => {
                ...
                let body = str::from_utf8(&body)
                    .map_err(|e| ApiError(format!("Response was not valid UTF8: {}", e)))?;
                let body = serde_json::from_str::<Vec<models::ApiEndpointsListMetrics200ResponseInner>>(body).map_err(|e| {
                    ApiError(format!("Response body did not match the schema: {}", e))
                })?;
                Ok(ApiPeriodEndpointsPeriodListMetricsResponse::Success
                    (body)
                )
            }
            code => {
    ...
    async fn api_period_endpoints_period_query(
        &self,
        param_api_endpoints_query_request: models::ApiEndpointsQueryRequest,
        context: &C) -> Result<ApiPeriodEndpointsPeriodQueryResponse, ApiError>
    {
        ...
        let body = serde_json::to_string(&param_api_endpoints_query_request).expect("impossible to fail to serialize");
        ...
        match response.status().as_u16() {
            200 => {
                ...
                let body = str::from_utf8(&body)
                    .map_err(|e| ApiError(format!("Response was not valid UTF8: {}", e)))?;
                let body = serde_json::from_str::<Vec<models::ApiEndpointsQuery200ResponseInner>>(body).map_err(|e| {
                    ApiError(format!("Response body did not match the schema: {}", e))
                })?;
                Ok(ApiPeriodEndpointsPeriodQueryResponse::CanBeA
                    (body)
                )
            }
            code => {
